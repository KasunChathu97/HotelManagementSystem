  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-slate-400">Manage portal themes, hotel configurations, and parameters.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 shadow-lg">
            <h3 className="text-base font-bold text-slate-200 font-heading mb-1"><i className="fa-solid fa-palette text-brand-500 mr-2"></i>Appearance & Theme</h3>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 shadow-lg">
            <h3 className="text-base font-bold text-slate-200 font-heading mb-1"><i className="fa-solid fa-hotel text-brand-500 mr-2"></i>Hotel Configurations</h3>
            <p className="text-xs text-slate-400 mb-6">Update general resort data and stay policies.</p>

            <form onSubmit={saveHotelSettings} className="space-y-4">
              <div>
        ...
        <div className="space-y-6">
          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 shadow-lg">
            <h3 className="text-base font-bold text-slate-200 font-heading mb-4">System Information</h3>
            <div className="space-y-3.5 text-sm">
              <div className="flex justify-between border-b border-slate-850 pb-2">
                <span className="text-slate-400">Portal Version</span>
                <span className="font-bold text-slate-200">v1.2.4</span>
              </div>
              <div className="flex justify-between border-b border-slate-850 pb-2">
              ...
              <div className="flex justify-between border-b border-slate-850 pb-2">
                ...
                <span className="font-mono text-xs text-slate-350">localhost:5000</span>
              </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800/80 shadow-lg">
            <h3 className="text-base font-bold text-slate-200 font-heading mb-4">Quick Actions</h3>
            <div className="space-y-3">
              <button type="button" onClick={toggleTheme} className="w-full px-4 py-2.5 bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 rounded-xl transition-all text-sm font-medium">
                Toggle Theme Mode
              </button>
              <div className="text-xs text-slate-500 leading-relaxed">
                Theme switches apply immediately through the global app context.
              </div>
            </div>
          </div>
        </div>
